...
def write_data_atom(index_atom, atom):
    ...
    with open("P2VP.data", "a") as out_file:
...
for i in range(num_chains):
    ...
    for k in range(nB):
        ...
        if(k == nB-1):
            ...
            mpb = int(lenp(t1[i*nB+k+1],t1[i*nB+k])/bondm)
        totm += mpb
        #Final monomer on final bead
        for j in range(mpb):
            if(j== 0 and k == 0):               
                vec = np.asarray([t1[i*nB+1][0]-t1[i*nB][0],t1[i*nB+1][1]-t1[i*nB][1],t1[i*nB+1][2]-t1[i*nB][2]])
                lentv = lent(vec)
                ...
                atom.append([i, 6, 0.0, C_ali1])
                index_atom +=1
                
                posh_ali1 = getposh_ali2(posc_ali1, vecv)
                H_ali1 = np.asarray([posh_ali1[0], posh_ali1[1], posh_ali1[2], index_atom])
                atom.append([i, 7, 0.0, H_ali1])
                index_atom +=1
                
                posh_ali2 = getposh_ali3(posc_ali1, vecv)
                H_ali2 = np.asarray([posh_ali2[0], posh_ali2[1], posh_ali2[2], index_atom])
                atom.append([i, 7, 0.0, H_ali2])
                index_atom +=1
                
                posh_ali3 = getposc_ali2(posc_ali1, -vecm)
                ...
                bonding.append([7, int(C_ali1[3]), int(H_ali1[3])])
                bonding.append([7, int(C_ali1[3]), int(H_ali2[3])])
                bonding.append([7, int(C_ali1[3]), int(H_ali3[3])])            
                bonding.append([6, int(C_ali1[3]), int(C_ali2[3])])
                bonding.append([7, int(C_ali2[3]), int(H_ali4[3])])
                bonding.append([11, int(C_ali2[3]), int(C_aro6[3])])
                ...
                bonding.append([6, int(C_ali2[3]), int(index_atom)]) ##bonding to next monomer
                
            ##Storing angle information of monomer
                angle.append([7, int(H_ali1[3]), int(C_ali1[3]), int(H_ali2[3])])
                angle.append([7, int(H_ali1[3]), int(C_ali1[3]), int(H_ali3[3])])
                angle.append([7, int(H_ali3[3]), int(C_ali1[3]), int(H_ali2[3])])
                angle.append([6, int(H_ali1[3]), int(C_ali1[3]), int(C_ali2[3])])
                angle.append([6, int(H_ali2[3]), int(C_ali1[3]), int(C_ali2[3])])
                angle.append([6, int(H_ali3[3]), int(C_ali1[3]), int(C_ali2[3])])
                angle.append([6, int(H_ali4[3]), int(C_ali2[3]), int(C_ali1[3])])
                angle.append([6, int(H_ali4[3]), int(C_ali2[3]), int(index_atom)])
                angle.append([6, int(index_atom+1), int(index_atom), int(C_ali2[3])])
                angle.append([6, int(index_atom+2), int(index_atom), int(C_ali2[3])])
                angle.append([6, int(C_aro6[3]), int(C_ali2[3]), int(H_ali4[3])])
                angle.append([8, int(C_ali1[3]), int(C_ali2[3]), int(index_atom)])
                angle.append([8, int(C_ali2[3]), int(index_atom), int(index_atom+3)])
                angle.append([8, int(C_ali1[3]), int(C_ali2[3]), int(C_aro6[3])])
                angle.append([8, int(index_atom), int(C_ali2[3]), int(C_aro6[3])])
                angle.append([9, int(C_ali2[3]), int(C_aro6[3]), int(C_aro5[3])])
                angle.append([10, int(C_ali2[3]), int(C_aro6[3]), int(N_aro1[3])])
            ...
            ##Storing dihedral information of monomer
                ...
                dihedral.append([1, int(C_ali2[3]), int(index_atom), int(index_atom+3), int(index_atom+15)])
